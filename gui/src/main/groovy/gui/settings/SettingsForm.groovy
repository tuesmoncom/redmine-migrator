 ...
 /**
    ...
    public SettingsForm() {
        ...
        SettingsForm initComponents() {
                ...
                jSeparator2.setName('tuesmonSeparator')
                ...
                jLabel3.setName("tuesmonUrlLabel");
                jTextField3.setName("tuesmonUrl");
                jLabel4.setName("tuesmonUsernameLabel");
                jTextField4.setName("tuesmonUsername");
                ...
                jLabel5.setName("tuesmonPasswordLabel");

                jPasswordField1.setName("tuesmonPassword");
