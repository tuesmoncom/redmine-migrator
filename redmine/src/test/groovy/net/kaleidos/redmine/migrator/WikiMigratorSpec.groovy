...
class WikiMigratorSpec extends MigratorToTuesmonSpecBase {
    ...
    void 'migrating project wikies'() {
        setup: 'building a simple migrator instance'
            ...
            WikiMigrator wikiMigrator = new WikiMigrator(redmineClient, tuesmonClient)
        when: 'trying to migrate basic estructure of a redmine project'
            ...
            List<TuesmonWikiPage> wikiPages = wikiMigrator.migrateWikiPagesByProject(migratedProjectInfo)
            TuesmonWikiPage homeWikiPage = wikiMigrator.setWikiHomePage(wikiPages)
